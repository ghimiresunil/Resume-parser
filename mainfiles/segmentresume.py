import pickle
from configuration import ResumeSegmentationModelPath
class ResumeSegmentCreator:

    def __init__(self):
        self.personal_info = set("profile information personal information additional information information: informations: introduction introduction:".split(' '))
        ...
        with open('./models/segment_identifier.pkl' ,'rb') as pkl:
